        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(
                    choices=[('article', 'article'), ('dataset', 'dataset'), ('book', 'book'), ('website', 'website'),
                             ('custom', 'custom'), ('waste_flyer', 'waste_flyer')], default='custom', max_length=255)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 related_name='bibliography_source_created',
                ...
                ('lastmodified_by',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                   related_name='bibliography_source_lastmodified', to=settings.AUTH_USER_MODEL,
                                   verbose_name='Last modified by')),
                ('licence', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                              to='bibliography.licence')),
