...
urlpatterns = [
    ...
    path('region_geometries/', RegionGeometryAPI.as_view(), name='data.region-geometries'),
    ...
    path('catchment_geometries/', CatchmentGeometryAPI.as_view(), name='data.catchment-geometries'),
