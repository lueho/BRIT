...
from .views import (AttributeCreateView, AttributeDetailView, AttributeListView, AttributeModalCreateView,
                    AttributeModalDeleteView, AttributeModalDetailView, AttributeModalUpdateView, AttributeUpdateView,
                    ...
                    CatchmentOptionGeometryAPI, CatchmentRegionGeometryAPI, CatchmentRegionSummaryAPIView,
                    CatchmentUpdateView, GeoDataSetCreateView, GeoDataSetListView, GeoDataSetModalDeleteView,
                    GeoDataSetUpdateView, LauRegionOptionsAPI, LocationCreateView, LocationDetailView, LocationListView,
                    LocationModalDeleteView, LocationUpdateView, MapsDashboardView, NutsAndLauCatchmentPedigreeAPI,
                    NutsRegionAutocompleteView, NutsRegionMapView, NutsRegionParentsDetailAPI, NutsRegionPedigreeAPI,
                    NutsRegionSummaryAPIView, PublishedCatchmentListView, PublishedGeoDatasetFilterView,
                    RegionAttributeValueCreateView, RegionAttributeValueDetailView, RegionAttributeValueListView,
                    ...
                    RegionListView, RegionMapView, RegionModalDeleteView, RegionOfLauAutocompleteView, RegionUpdateView,
                    UserOwnedCatchmentListView)

urlpatterns = [
    path('list/', PublishedGeoDatasetFilterView.as_view(), name='maps_list'),
    path('geodatasets/', GeoDataSetListView.as_view(), name='geodataset-list'),
