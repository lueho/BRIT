# Generated by Django 3.2.10 on 2022-04-04 09:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maps_attribute_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('lastmodified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='maps_attribute_lastmodified', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard_deviation', models.FloatField(blank=True, null=True, default=0.0)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 related_name='maps_regionattributevalue_created',
                ...
                ('lastmodified_by',
                 models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                   related_name='maps_regionattributevalue_lastmodified', to=settings.AUTH_USER_MODEL,
