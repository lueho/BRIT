    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('model_name', models.CharField(choices=[('HamburgRoadsideTrees', 'HamburgRoadsideTrees'), ('HamburgGreenAreas', 'HamburgGreenAreas')], max_length=56, null=True)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameter', models.ManyToManyField(to='scenario_builder.InventoryAlgorithmParameter')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stan_flow_id', models.CharField(max_length=5, validators=[django.core.validators.RegexValidator(code='invalid_stan_id', message='STAN id must have 5 digits.s', regex='^[0-9]{5}?')])),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('feedstock', models.ForeignKey(limit_choices_to={'is_feedstock': True}, on_delete=django.db.models.deletion.CASCADE, to='scenario_builder.Material')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('standard_deviation', models.FloatField(null=True)),
                ('fraction_of', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='scenario_builder.MaterialComponent')),
                ('groups', models.ManyToManyField(to='scenario_builder.MaterialComponentGroup')),
                ('literature_source', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='scenario_builder.LiteratureSource')),
                ('material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='scenario_builder.Material')),
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
