...
urlpatterns = [
    ...
    path('scenarios/<int:scenario_pk>/materials/<int:material_pk>/component_groups/<int:group_pk>/remove/',
         MaterialComponentGroupRemoveView.as_view(),
         name='material_component_group_remove'),
    path('scenarios/<int:scenario_pk>/materials/<int:material_pk>/component_groups/<int:group_pk>/shares/create/',
         MaterialComponentGroupShareCreateView.as_view(),
         name='material_component_group_shares_create'),
    path('scenarios/<int:scenario_pk>/materials/<int:material_pk>/component_groups/<int:group_pk>/shares/update/',
         MaterialComponentGroupShareDistributionUpdateView.as_view(),
         name='material_component_group_shares_update'),
