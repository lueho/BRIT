...
urlpatterns = [
    ...
    path(
        'scenarios/<int:scenario_pk>/materials/<int:material_pk>/component_groups/<int:group_pk>/shares/<int:timestep_pk>/update/',
        MaterialComponentGroupShareDistributionUpdateView.as_view(),
        name='material_component_group_share_distribution_update'),
    path(
        'scenarios/<int:scenario_pk>/materials/<int:material_pk>/component_groups/<int:group_pk>/add_temporal_distribution/',
