...
from .views import (CatchmentCreateView,
                    ...
                    MaterialComponentGroupRemoveView,
                    MaterialComponentGroupRemoveComponentView,
                    MaterialComponentGroupShareCreateView,
...
urlpatterns = [
    ...
    path('scenarios/<int:scenario_pk>/materials/<int:material_pk>/add_component_group/',
         MaterialAddComponentGroupView.as_view(), name='material_add_component_group'),
    ...
    path('scenarios/<int:scenario_pk>/material/<int:material_pk>/component_groups/<int:group_pk>/remove/',
         MaterialComponentGroupRemoveView.as_view(),
         name='material_component_group_remove'),
    path('scenarios/<int:scenario_pk>/material/<int:material_pk>/component_groups/<int:group_pk>/shares/create/',
         MaterialComponentGroupShareCreateView.as_view(),
         name='material_component_group_share_create'),
    path('scenarios/<int:scenario_pk>/material/<int:material_pk>/component_groups/<int:group_pk>/shares/update/',
         MaterialComponentGroupShareUpdateView.as_view(),
         name='material_component_group_share_update'),
    ...
    path('formsettest/', ShareFormsetTestView.as_view(), name='shareformsettest'),
]
