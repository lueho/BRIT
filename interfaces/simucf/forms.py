...
from django.forms import DecimalField, IntegerField, ModelChoiceField
...
class SimuCFModelForm(SimpleForm):
    ...
    length_of_treatment = IntegerField(
        min_value=1, max_value=1000, initial=30, label="Length of treatment [d]"
    )
