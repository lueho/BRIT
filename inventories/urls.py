...
urlpatterns = [
    ...
    path('scenarios/<int:pk>/configurations/create/', ScenarioConfigurationCreateView.as_view(), name='scenarioconfiguration-create'),
    path('scenario_configurations/<int:pk>/update/', ScenarioConfigurationUpdateView.as_view(), name='scenarioconfiguration-update'),
    path('scenario_configurations/<int:pk>/delete/', ScenarioInventoryConfigurationModalDeleteView.as_view(), name='scenarioconfiguration-delete-modal'),
    ...
    path('api/result_layer/<layer_name>/', ResultMapAPI.as_view({'get': 'retrieve'}), name='api-resultlayer-detail'),
]
