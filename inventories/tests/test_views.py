...
class ScenarioModalCreateViewTestCase(ViewWithPermissionsTestCase):
    member_permissions = 'add_scenario'
    ...
    def test_get_http_302_redirect_to_login_for_anonymous(self):
        url = reverse('scenario-create-modal')
        response = self.client.get(url)
        self.assertRedirects(response, f'{reverse("auth_login")}?next={url}')

    def test_get_http_403_forbidden_for_outsiders(self):
        self.client.force_login(self.outsider)
        response = self.client.get(reverse('scenario-create-modal'))
        self.assertEqual(response.status_code, 403)
    ...
    def test_post_http_403_forbidden_for_outsiders(self):
        self.client.force_login(self.outsider)
        response = self.client.post(reverse('scenario-create-modal'))
        self.assertEqual(response.status_code, 403)
    ...
    def test_post_success_and_http_302_redirect_to_success_url_for_member(self):
        ...
        response = self.client.post(reverse('scenario-create-modal'), data)
        self.assertRedirects(
            response, reverse('scenario-detail', kwargs={'pk': Scenario.objects.first().pk})
        )
...
class ScenarioModalUpdateViewTestCase(ViewWithPermissionsTestCase):
    member_permissions = 'change_scenario'
    ...
    def test_get_http_302_redirect_to_login_for_anonymous(self):
        url = reverse('scenario-update-modal', kwargs={'pk': self.scenario.pk})
        response = self.client.get(url)
        self.assertRedirects(response, f'{reverse("auth_login")}?next={url}')

    def test_get_http_403_forbidden_for_outsiders(self):
        self.client.force_login(self.outsider)
        response = self.client.get(reverse('scenario-update-modal', kwargs={'pk': self.scenario.pk}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_post_http_403_forbidden_for_outsiders(self):
        self.client.force_login(self.outsider)
        response = self.client.post(reverse('scenario-update-modal', kwargs={'pk': self.scenario.pk}))
        self.assertEqual(response.status_code, 403)
    ...
    def test_post_success_and_http_302_redirect_to_success_url_for_member(self):
        ...
        response = self.client.post(reverse('scenario-update-modal', kwargs={'pk': self.scenario.pk}), data)
        self.assertRedirects(response, reverse('scenario-detail', kwargs={'pk': self.scenario.pk}))
