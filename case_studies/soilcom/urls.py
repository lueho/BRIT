...
from maps.views import CatchmentModalDeleteView, CatchmentUpdateView
from . import views
...
urlpatterns = [
    ...
    path('properties/create/', views.CollectionPropertyValueCreateView.as_view(), name='collectionpropertyvalue-create'),
    path('properties/<int:pk>/', views.CollectionPropertyValueDetailView.as_view(), name='collectionpropertyvalue-detail'),
    path('properties/<int:pk>/update/', views.CollectionPropertyValueUpdateView.as_view(), name='collectionpropertyvalue-update'),
    path('properties/<int:pk>/delete/modal/', views.CollectionPropertyValueModalDeleteView.as_view(), name='collectionpropertyvalue-delete-modal'),
    path('properties/aggregated/create/', views.AggregatedCollectionPropertyValueCreateView.as_view(), name='aggregatedcollectionpropertyvalue-create'),
    path('properties/aggregated/<int:pk>/', views.AggregatedCollectionPropertyValueDetailView.as_view(), name='aggregatedcollectionpropertyvalue-detail'),
    path('properties/aggregated/<int:pk>/update/', views.AggregatedCollectionPropertyValueUpdateView.as_view(), name='aggregatedcollectionpropertyvalue-update'),
    path('properties/aggregated/<int:pk>/delete/modal/', views.AggregatedCollectionPropertyValueModalDeleteView.as_view(), name='aggregatedcollectionpropertyvalue-delete-modal'),
    ...
    path('collections/', views.CollectionCurrentListView.as_view(), name='collection-list'),
    ...
    path('collections/<int:pk>/new_version/', views.CollectionCreateNewVersionView.as_view(), name='collection-new-version'),
    path('collections/<int:pk>/delete/modal/', views.CollectionModalDeleteView.as_view(), name='collection-delete-modal'),
    path('collections/<int:pk>/add_property/', views.CollectionAddPropertyValueView.as_view(), name='collection-add-property'),
