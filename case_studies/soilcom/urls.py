...
urlpatterns = [
    ...
    path('wastestreams/<int:pk>/update/modal/', views.WasteStreamModalUpdateView.as_view(),
         name='wastestream-update-modal'),
    path('wastestreams/<int:pk>/delete/modal/', views.WasteStreamModalDeleteView.as_view(),
         name='wastestream-delete-modal'),
