...
urlpatterns = [
    ...
    path('catchments/user/', views.CollectionCatchmentPrivateFilterView.as_view(),
    ...
    path('catchments/<int:pk>/update/', views.CollectionCatchmentUpdateView.as_view(),
         name='collectioncatchment-update'),
    path('catchments/<int:pk>/delete/modal/', CatchmentModalDeleteView.as_view(),
         name='collectioncatchment-delete-modal'),
    path('catchments/<int:pk>/add_aggregated_property/', views.CollectionCatchmentAddAggregatedPropertyView.as_view(),
    ...
    path('feesystems/', views.FeeSystemPublishedListView.as_view(), name='feesystem-list'),
    path('feesystems/user/', views.FeeSystemPrivateListView.as_view(), name='feesystem-list-owned'),
    path('feesystems/create/', views.FeeSystemCreateView.as_view(), name='feesystem-create'),
    path('feesystems/<int:pk>/', views.FeeSystemDetailView.as_view(), name='feesystem-detail'),
    path('feesystems/<int:pk>/update/', views.FeeSystemUpdateView.as_view(), name='feesystem-update'),
    path('feesystems/<int:pk>/delete/modal/', views.FeeSystemModalDeleteView.as_view(), name='feesystem-delete-modal'),
    ...
    path('collections/map/', views.WasteCollectionPublishedMapView.as_view(), name='WasteCollection'),
    path('collections/map/user/', views.WasteCollectionPrivateMapView.as_view(), name='WasteCollection-owned'),
    path('collections/map/iframe/', views.WasteCollectionPublishedMapIframeView.as_view(),
