...
class CollectionModelSerializer(FieldLabelModelSerializer):
    ...
    min_bin_size = serializers.DecimalField(max_digits=10, decimal_places=2, required=False, allow_null=True)
    required_bin_capacity = serializers.DecimalField(max_digits=10, decimal_places=2, required=False, allow_null=True)
