...
from case_studies.soilcom.vocabulary import SEMANTIC_CONTRACT, get_concepts_by_uri
...
class CrosswalkPreprocessingTestCase(SimpleTestCase):
    ...
    @patch("case_studies.soilcom.crosswalk.get_ttl_concept_registry")
...
class ValidateSoilcomCrosswalksCommandTestCase(SimpleTestCase):
    ...
    @patch(
        "case_studies.soilcom.management.commands.validate_soilcom_crosswalks.validate_crosswalk_mappings"
    )
