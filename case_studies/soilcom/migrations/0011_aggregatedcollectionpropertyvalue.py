# Generated by Django 3.2.10 on 2022-11-22 08:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('soilcom', '0010_collectionpropertyvalue'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='soilcom_aggregatedcollectionpropertyvalue_created', to=settings.AUTH_USER_MODEL, verbose_name='Created by')),
                ('lastmodified_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='soilcom_aggregatedcollectionpropertyvalue_lastmodified', to=settings.AUTH_USER_MODEL, verbose_name='Last modified by')),
