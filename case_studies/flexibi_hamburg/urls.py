...
from .views import (HamburgRoadsideTreeCatchmentAutocompleteView, HamburgRoadsideTreesListFileExportView,
                    RoadsideTreesPublishedMapIframeView, RoadsideTreesPublishedMapView)

urlpatterns = [
    path('roadside_trees/map/', RoadsideTreesPublishedMapView.as_view(), name='HamburgRoadsideTrees'),
    path('roadside_trees/map/iframe/', RoadsideTreesPublishedMapIframeView.as_view(), name='HamburgRoadsideTreesIframe'),
