...
from .renderers import NantesGreenhousesCSVRenderer, NantesGreenhousesXLSXRenderer
...
def export_nantes_greenhouses_to_file(self, file_format, query_params):
    ...
    if file_format == "xlsx":
        return utils.file_export.storages.write_file_for_download(
            file_name, data, NantesGreenhousesXLSXRenderer
        )
    else:
        return utils.file_export.storages.write_file_for_download(
            file_name, data, NantesGreenhousesCSVRenderer
        )
