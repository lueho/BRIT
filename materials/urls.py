...
urlpatterns = [
    ...
    path('materials/create/modal/', views.MaterialModalCreateView.as_view(), name='material-create-modal'),
    path('materials/<int:pk>/', views.MaterialDetailView.as_view(), name='material-detail'),
    path('materials/<int:pk>/modal/', views.MaterialModalDetailView.as_view(), name='material-detail-modal'),
    path('materials/<int:pk>/update/', views.MaterialUpdateView.as_view(), name='material-update'),
    path('materials/<int:pk>/update/modal/', views.MaterialModalUpdateView.as_view(), name='material-update-modal'),
    path('materials/<int:pk>/delete/', views.MaterialModalDeleteView.as_view(), name='material-delete-modal'),
    path('materials/autocomplete/', views.MaterialAutocompleteView.as_view(), name='material-autocomplete'),
    path('analytical_methods/', views.AnalyticalMethodPublishedListView.as_view(), name='analyticalmethod-list'),
    path('analytical_methods/user/', views.AnalyticalMethodPrivateListView.as_view(), name='analyticalmethod-list-owned'),
    path('analytical_methods/create/', views.AnalyticalMethodCreateView.as_view(), name='analyticalmethod-create'),
    path('analytical_methods/<int:pk>/', views.AnalyticalMethodDetailView.as_view(), name='analyticalmethod-detail'),
    path('analytical_methods/<int:pk>/modal/', views.AnalyticalMethodModalDetailView.as_view(), name='analyticalmethod-detail-modal'),
    path('analytical_methods/<int:pk>/update/', views.AnalyticalMethodUpdateView.as_view(), name='analyticalmethod-update'),
    path('analytical_methods/<int:pk>/delete/modal/', views.AnalyticalMethodModalDeleteView.as_view(), name='analyticalmethod-delete-modal'),
    path('sample_series/', views.SampleSeriesPublishedListView.as_view(), name='sampleseries-list'),
    ...
    path('sample_series/user/', views.SampleSeriesPrivateListView.as_view(), name='sampleseries-list-owned'),
    ...
    path('samples/user/', views.SamplePrivateListView.as_view(), name='sample-list-owned'),
    ...
    path('categories/', views.MaterialCategoryPublishedListView.as_view(), name='materialcategory-list'),
    path('categories/user/', views.MaterialCategoryPrivateListView.as_view(), name='materialcategory-list-owned'),
    path('categories/create/', views.MaterialCategoryCreateView.as_view(), name='materialcategory-create'),
    path('categories/create/modal/', views.MaterialCategoryModalCreateView.as_view(), name='materialcategory-create-modal'),
    ...
    path('components/', views.ComponentPublishedListView.as_view(), name='materialcomponent-list'),
    path('components/user/', views.ComponentPrivateListView.as_view(), name='materialcomponent-list-owned'),
    ...
    path('componentgroups/', views.MaterialComponentGroupPublishedListView.as_view(), name='materialcomponentgroup-list'),
    path('componentgroups/user/', views.MaterialComponentGroupPrivateListView.as_view(), name='materialcomponentgroup-list-owned'),
    path('componentgroups/create/', views.MaterialComponentGroupCreateView.as_view(), name='materialcomponentgroup-create'),
    path('componentgroups/create/modal/', views.MaterialComponentGroupModalCreateView.as_view(), name='materialcomponentgroup-create-modal'),
    path('componentgroups/<int:pk>/', views.MaterialComponentGroupDetailView.as_view(), name='materialcomponentgroup-detail'),
    path('componentgroups/<int:pk>/modal/', views.MaterialComponentGroupModalDetailView.as_view(), name='materialcomponentgroup-detail-modal'),
    path('componentgroups/<int:pk>/update/', views.MaterialComponentGroupUpdateView.as_view(), name='materialcomponentgroup-update'),
    path('componentgroups/<int:pk>/update/modal/', views.MaterialComponentGroupModalUpdateView.as_view(), name='materialcomponentgroup-update-modal'),
    path('componentgroups/<int:pk>/delete/modal/', views.MaterialComponentGroupModalDeleteView.as_view(), name='materialcomponentgroup-delete-modal'),
    path('properties/', views.MaterialPropertyPublishedListView.as_view(), name='materialproperty-list'),
    path('properties/user/', views.MaterialPropertyPrivateListView.as_view(), name='materialproperty-list-owned'),
    ...
    path('compositions/create/modal/', views.CompositionModalCreateView.as_view(), name='composition-create-modal'),
