...
urlpatterns = [
    ...
    path('compositionsets/<int:pk>/update/', views.CompositionSetModalUpdateView.as_view(), name='composition_set_update'),
    path('materialcomponentgroups/<int:pk>/delete/', views.ComponentGroupDeleteView.as_view(),
         name='material_component_group_delete'),
    path('materialcomponentgroups/settings/<int:pk>/add_component/', views.AddComponentView.as_view(), name='add_component'),
