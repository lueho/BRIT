...
class MaterialViewSetTestCase(ViewSetWithPermissionsTestCase):
    ...
    def test_get_detail_http_401_unauthenticated_for_not_authenticated_user(self):
        response = self.client.get(
            reverse("api-material-detail", kwargs={"pk": self.material.pk})
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_no_reverse_match_for_update_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-material-update", kwargs={"pk": self.material.pk}), data={}
            )

    def test_no_reverse_match_for_delete_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-material-delete", kwargs={"pk": self.material.pk}), data={}
            )
...
class SampleSeriesViewSetTestCase(ViewSetWithPermissionsTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.series = SampleSeries.objects.create(
            material=cls.material, name="Test Series"
        )
    ...
    def test_get_detail_http_401_unauthenticated_for_not_authenticated_user(self):
        response = self.client.get(
            reverse("api-sampleseries-detail", kwargs={"pk": self.series.pk})
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_no_reverse_match_for_update_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-sampleseries-update", kwargs={"pk": self.series.pk}),
                data={},
            )
    ...
    def test_no_reverse_match_for_delete_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-sampleseries-delete", kwargs={"pk": self.series.pk}),
                data={},
            )
...
class SampleViewSetTestCase(ViewSetWithPermissionsTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.sample = Sample.objects.create(
            series=cls.series, material=cls.material, name="Test Sample"
        )
    ...
    def test_no_reverse_match_for_update_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-sample-update", kwargs={"pk": self.sample.pk}), data={}
            )

    def test_no_reverse_match_for_delete_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-sample-delete", kwargs={"pk": self.sample.pk}), data={}
            )
...
class CompositionViewSetTestCase(ViewSetWithPermissionsTestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.composition = Composition.objects.create(
            name="Test Composition", sample=cls.sample, group=cls.group
        )
    ...
    def test_no_reverse_match_for_update_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-composition-update", kwargs={"pk": self.composition.pk}),
                data={},
            )
    ...
    def test_no_reverse_match_for_delete_link(self):
        with self.assertRaises(NoReverseMatch):
            self.client.post(
                reverse("api-composition-delete", kwargs={"pk": self.composition.pk}),
                data={},
            )
