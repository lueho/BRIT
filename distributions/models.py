...
class Period(UserCreatedObject):
    ...
    first_timestep = models.ForeignKey(
        Timestep, on_delete=models.PROTECT, related_name="first_of_periods"
    )
    last_timestep = models.ForeignKey(
        Timestep, on_delete=models.PROTECT, related_name="last_of_periods"
    )
