...
MOCK_PROCESS_TYPES = [
    ...
    },
    {
        ...
        "category": "Physical",
        "input": [
            {"name": "Lignocellulosic Biomass", "id": 301}
        ],
        "output": [
            {"name": "Exploded Biomass", "id": 305}
        ],
    ...
    },
    {
        ...
        "output": [
            {"name": "Disintegrated Sludge", "id": 402}
        ],
...
class ProcessMockDashboard(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        return {
            "process_types": MOCK_PROCESS_TYPES
        }
