...
from ..widgets import NullablePercentageRangeSliderWidget
...
class NullablePercentageRangeFieldTests(TestCase):
    def test_uses_percentage_range_slider_widget(self):
        field = NullablePercentageRangeField()
        self.assertIsInstance(field.widget, NullablePercentageRangeSliderWidget)
