...
class BaseAPITestCase(TestCase):
    ...
    # ------------------------------------------------------------------
    # tiny helper used by most tests
    # ------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Mock model and viewset for *user‑created* objects
# ---------------------------------------------------------------------------
...
# ===========================================================================
# 3. User‑created object ViewSet tests
# ===========================================================================
...
class UserCreatedObjectWorkflowTests(BaseAPITestCase):
    ...
    def _action(self, action: str, obj: MockUserCreatedObject):
        ...
        with (
            patch("utils.viewsets.get_object_or_404", return_value=obj),
            patch(
                "utils.viewsets.Response",
