"""Export waste collection controlled vocabulary snapshots.

Usage::

    docker compose exec web python manage.py export_waste_collection_vocabulary
    docker compose exec web python manage.py export_waste_collection_vocabulary \
        --output /app/sources/waste_collection/ontology/export/controlled_vocabulary.json
    docker compose exec web python manage.py export_waste_collection_vocabulary --fail-on-unmapped
"""
...
class Command(BaseCommand):
    ...
    help = (
        "Export a JSON snapshot of the waste collection controlled vocabulary for "
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--output",
            type=str,
            default="/app/sources/waste_collection/ontology/export/controlled_vocabulary.json",
